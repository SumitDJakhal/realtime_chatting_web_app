...
//     fetchAndDisplayUsers(searchQuery);
// });


//   // Check if the username and password are 'admin'
//     if (username == 'admin' && password == 'admin') {
//         // If username and password are both 'admin', grant access
//         res.status(200).end("Access granted.")
//     } else {
//         res.status(401).end("Unauthorized access.") // 401 "unauthorized" error
...
//Homepage displayed to signed in admin
const homePageadmin = async(req, res, next) => {
...
const adminPanel = (req, res, next) => {
    ...
    // Assuming you have a function to get all users from your database
